package com.chen.auth.server.enums;

import com.chen.auth.server.utils.SnowFlake;
...
public class Constant {
	...
	//jwt 刷新token
	public static final String JWT_REFRESHTOKEN_REDIS_KEY_PREFIX="UserAuth:JWT:REFRESH:Key:";
